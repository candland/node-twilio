...
/**
 * getApplications: Request a list of applications
 *
 * @param {String} friendlyName: Optional friendly name filter.
 */
RestClient.prototype.getApplications = function(friendlyName, suc, err) {
	if (err === undefined || err === null) {
		err = suc;
		suc = friendlyName;
	}
		
	this.apiCall('GET', '/Applications', {params: {friendlyName: friendlyName}}, suc, err);
};

/**
 * getApplication: Request an Application
 *
 * @param {String} sid: Application Id
 */
RestClient.prototype.getApplication = function(sid, suc, err) {
	if (!sid) throw new Error('sid is required.');

	this.apiCall('GET', '/Applications/' + sid, {}, suc, err);
};

/**
 * updateApplication: Request a list of applications
 *
 * @param {String} sid: Application Id
 * @param {Object} params: Params to update an Application
 */
...
/**
 * addApplication: Request a list of applications
 *
 * @param {Object} params: Params to add an Application
 */
RestClient.prototype.addApplication = function(params, suc, err) {
